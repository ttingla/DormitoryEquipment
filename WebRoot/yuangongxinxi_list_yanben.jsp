...
<script type="text/javascript" src="js/My97DatePicker/WdatePicker.js" charset="gb2312"></script>
	...
	<form action="yuangongxinxiList.action" name="formAdd" method="post">
				     <table width="98%" align="center" border="1" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						<tr bgcolor="#E7E7E7">
							<td height="10" colspan="8" background="img/tbg.gif">所有员工信息列表</td>
						</tr>
  ...
  %>>
					...
					<td width="200px" height="50"  align="center">
						     <!--lianjie1--> <input type="button" value="详细" onclick="yuangongxinxiDetail(${yuangongxinxi.id})" class="btn btn-info btn-small" />					</td>
				</tr>
				</c:forEach>
	</table>
