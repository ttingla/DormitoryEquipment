		    ...
		    <table border='0' cellpadding='0' cellspacing='0' align="center">
		        <tr>
			        <td width='98%' align="right">
			                ...
			                <c:if test="${requestScope.page.index!=1}">
			                       <a class="btn btn-info btn-small" href='#' onclick="go(1)">首&nbsp;&nbsp;页</a>
			                       &nbsp;&nbsp;&nbsp;&nbsp;
			                       <a class="btn btn-info btn-small" href='#' onclick="go(${requestScope.page.index-1})">上一页</a>
			                       &nbsp;&nbsp;&nbsp;&nbsp;
			                </c:if>
			                ...
			                <c:if test="${requestScope.page.index < requestScope.page.totlePage}">
			                       <a class="btn btn-info btn-small" href='#' onclick="go(${requestScope.page.index+1})">下一页</a>
			                       &nbsp;&nbsp;&nbsp;&nbsp;
			                       <a class="btn btn-info btn-small" href='#' onclick="go(${requestScope.page.totlePage})">末&nbsp;&nbsp;页</a>
			                </c:if>
			        </td>
		       </tr>
		    </table>  