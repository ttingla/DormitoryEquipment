...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="yuangongxinxiAdd.action" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#CCCCCC" style="border-collapse:collapse">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" >添加员工信息
...
if(gonghaoobj.value!=""){  
var ajax = new AJAX();
ajax.post("factory/checkno.jsp?table=yuangongxinxi&col=gonghao&value="+gonghaoobj.value+"&checktype=insert") 
