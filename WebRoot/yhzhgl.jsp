...
<form  action="allusersAdd.action"  method="post" name="f1"  onsubmit="return checkform();">
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#cccccc" >    
     <tr>
      ...
      <td><input name="username" type="text" id="username" onblur='hsgcheck()' class="form-control" /> <label id='clabelusername' style="margin-top:16px;" />
      *</td>
    </tr>
    <tr>
      <td width="200">密码：</td>
      <td><input name="pwd" type="password" id="pwd" onblur='checkform()' class="form-control" /> <label id='clabelpwd' style="margin-top:16px;" />
      *</td>
    </tr>
    <tr>
      <td width="200">确认密码：</td>
      <td><input name="pwd2" type="password" id="pwd2" onblur='checkform()' class="form-control" /> <label id='clabelpwd2' style="margin-top:16px;" />
      *</td>
    </tr>
    <tr>
      <td width="200" height="45">&nbsp;</td>
      <td height="45"><input type="submit" name="Submit5" id="Submit5" value="提交" onClick="return checkform();" class="btn btn-info btn-small" />
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="cccccc" style="border-collapse:collapse">  
  <tr>
    ...
    <td height="30" align="center" bgcolor="cccccc">添加时间</td>
 ...
 <%
  ...
  <tr>
    <td height="45"><%=i %></td>
    <td height="45">${allusers.username}</td>
    <td height="45">${allusers.pwd}</td>
    <td height="45">${allusers.cx}</td>
    <td height="45" align="center">${allusers.addtime}</td>
    <td width="100" height="45" align="center"> <input type="button" value="删除" onClick="allusersDel(${allusers.id})" class="btn btn-info btn-small" /></td>
  </tr>
 </c:forEach>
</table>
  </body>
